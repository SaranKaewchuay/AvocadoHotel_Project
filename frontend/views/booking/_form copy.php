...
/* @var $form yii\widgets\ActiveForm */
    ...
    //$this_booking = Booking::find()->where(["room_id" => $model->room_type])->all();
...
var_dump("select === ", $select);
    ...
    var_dump("Cut == ", $all);
    if(count($select) != count($all)){
        var_dump("C == ",count($select));
        var_dump("C == ",count($all));
